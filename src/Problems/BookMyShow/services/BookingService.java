...
import Problems.BookMyShow.utility.BookingDataFactory;

import java.util.*;
import java.util.Scanner;

public class BookingService {
    private static BookingService instance; //  Single Instance
    private final MovieController movieController;
    private final TheatreController theatreController;
    private final Scanner scanner;

    private BookingService(){ // Private constructor -> hum chhate hai ki koi bhi class isko getInstance() method se he call kre
